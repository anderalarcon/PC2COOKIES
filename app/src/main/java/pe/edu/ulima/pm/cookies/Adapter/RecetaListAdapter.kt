...
class RecetaListAdapter(
    ...
    class ViewHolder(view: View, val listener: (Receta) -> Unit, val RecetaList: List<Receta>) :
        ...
        override fun onClick(v: View?) {
            listener(RecetaList[adapterPosition])//En que posicion se ha registrado el view holder
        }
    }
